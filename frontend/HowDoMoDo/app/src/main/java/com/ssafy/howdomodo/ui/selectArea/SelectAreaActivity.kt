...
class SelectAreaActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        //영화관 리스트
        val theaterAdapter = TheaterAdapter(this, theaterList) { theater ->
            //영화관 클릭 이벤트
            Toast.makeText(this, "선택하신 영화관은 ${theater.name} ${theater.kind} ${theater.distance}", Toast.LENGTH_SHORT).show()
